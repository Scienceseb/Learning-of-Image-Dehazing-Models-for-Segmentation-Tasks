...
2) Make a folder called cityscape, the path to that folder is your "path_exp", make 3 sub-folders: a,b and c. Put the hazy images in a, the non-hazy images in b and the segmentation masks in c.<br/>
